...
## copy STATIONS
#ISRC_WORKING_DIR_STATIONS=$ISRC_WORKING_DIR/DATA/STATIONS
#ISRC_WORKING_DIR_STATIONS_isource=$( seq --format="$ISRC_WORKING_DIR_STATIONS/%06.f/" $(($isource-1)) $(($isource-1)) ) # STATIONS corresponding to current isource

#cp -r $ISRC_WORKING_DIR_STATIONS_isource/STATIONS ./DATA
