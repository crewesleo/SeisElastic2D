...
! external models
  ...
  allocate(vpext(NGLLX,NGLLZ,nspec_ext), &
           ...
           c22ext(NGLLX,NGLLZ,nspec_ext), &
           m1ext(NGLLX,NGLLZ,nspec_ext), &
           m2ext(NGLLX,NGLLZ,nspec_ext), &
           m3ext(NGLLX,NGLLZ,nspec_ext), &
           m4ext(NGLLX,NGLLZ,nspec_ext), &
           m5ext(NGLLX,NGLLZ,nspec_ext), &
           m6ext(NGLLX,NGLLZ,nspec_ext), &
           thetaext(NGLLX,NGLLZ,nspec_ext), &
           c11uext(NGLLX,NGLLZ,nspec_ext), &
           c13uext(NGLLX,NGLLZ,nspec_ext), &
           c33uext(NGLLX,NGLLZ,nspec_ext), &
           c55uext(NGLLX,NGLLZ,nspec_ext),stat=ier)
