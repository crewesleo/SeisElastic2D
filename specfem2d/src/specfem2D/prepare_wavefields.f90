...
!========================================================================
  ...
  allocate(dl_lambda_k(nglob_elastic_b))
  allocate(dl_mu_k(nglob_elastic_b))
  allocate(dl_rho_k(nglob_elastic_b))
  allocate(dip_ip_k(nglob_elastic_b))
  allocate(dip_is_k(nglob_elastic_b))
  allocate(dip_rho_k(nglob_elastic_b))
  allocate(vipi_vp_k(nglob_elastic_b))
  allocate(vipi_vs_k(nglob_elastic_b))
  allocate(vipi_ip_k(nglob_elastic_b))
  allocate(vipii_vp_k(nglob_elastic_b))
  allocate(vipii_vs_k(nglob_elastic_b))
  allocate(vipii_is_k(nglob_elastic_b))
  allocate(sigma_vp_k(nglob_elastic_b))
  allocate(sigma_sigma_k(nglob_elastic_b))
  allocate(sigma_rho_k(nglob_elastic_b))
  ...
  ! TTI PWY
  allocate(tti_ec_rho_k(nglob_elastic_b))
  allocate(tti_ec_c11_k(nglob_elastic_b))
  allocate(tti_ec_c13_k(nglob_elastic_b))
  allocate(tti_ec_c15_k(nglob_elastic_b))
  allocate(tti_ec_c33_k(nglob_elastic_b))
  allocate(tti_ec_c35_k(nglob_elastic_b))
  allocate(tti_ec_c55_k(nglob_elastic_b))

  allocate(tti_ecu_rho_k(nglob_elastic_b))
  allocate(tti_ecu_c11_k(nglob_elastic_b))
  allocate(tti_ecu_c13_k(nglob_elastic_b))
  allocate(tti_ecu_c33_k(nglob_elastic_b))
  allocate(tti_ecu_c55_k(nglob_elastic_b))
  allocate(tti_ecu_theta_k(nglob_elastic_b))

  allocate(tti_thom_rhop_k(nglob_elastic_b))
  allocate(tti_thom_alpha_k(nglob_elastic_b))
  allocate(tti_thom_beta_k(nglob_elastic_b))
  allocate(tti_thom_epsilon_k(nglob_elastic_b))
  allocate(tti_thom_delta_k(nglob_elastic_b))
  allocate(tti_thom_theta_k(nglob_elastic_b))

  ! HTI PWY
  allocate(hti_ec_rho_k(nglob_elastic_b))
  allocate(hti_ec_c11_k(nglob_elastic_b))
  allocate(hti_ec_c13_k(nglob_elastic_b))
  allocate(hti_ec_c33_k(nglob_elastic_b))
  allocate(hti_ec_c55_k(nglob_elastic_b))
  ! HTI Thomsen parameterization PWY
  allocate(hti_thom_rhop_k(nglob_elastic_b))
  allocate(hti_thom_alpha_k(nglob_elastic_b))
  allocate(hti_thom_beta_k(nglob_elastic_b))
  allocate(hti_thom_epsilon_k(nglob_elastic_b))
  allocate(hti_thom_delta_k(nglob_elastic_b))
  ! HTI Thomsen2 parameterization PWY
  allocate(hti_thom2_rhop_k(nglob_elastic_b))
  allocate(hti_thom2_alpha_k(nglob_elastic_b))
  allocate(hti_thom2_beta_k(nglob_elastic_b))
  allocate(hti_thom2_epsilon_k(nglob_elastic_b))
  allocate(hti_thom2_delta_k(nglob_elastic_b))
  allocate(hti_thom2_eta_k(nglob_elastic_b))

  allocate(hti_vel_rhop_k(nglob_elastic_b))
  allocate(hti_vel_alpha_k(nglob_elastic_b))
  allocate(hti_vel_beta_k(nglob_elastic_b))
  allocate(hti_vel_alphah_k(nglob_elastic_b))
  allocate(hti_vel_alphan_k(nglob_elastic_b))

  ! ATtenuation by PWY 04-29-2018
  allocate(Qalpha_k(nglob_elastic_b))
  allocate(Qbeta_k(nglob_elastic_b))
  allocate(Qkappa_k(nglob_elastic_b))
  allocate(Qmu_k(nglob_elastic_b))
  ! on local nodes
  ...
  allocate(dl_lambda_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(dl_mu_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(dl_rho_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(dip_ip_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(dip_is_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(dip_rho_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(vipi_vp_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(vipi_vs_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(vipi_ip_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(vipii_vp_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(vipii_vs_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(vipii_is_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(sigma_vp_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(sigma_sigma_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(sigma_rho_kl(NGLLX,NGLLZ,nspec_elastic_b))
  ...
  allocate(hti_ec_rho_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_ec_c11_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_ec_c13_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_ec_c33_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_ec_c55_kl(NGLLX,NGLLZ,nspec_elastic_b))

  allocate(tti_ec_rho_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(tti_ec_c11_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(tti_ec_c13_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(tti_ec_c15_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(tti_ec_c33_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(tti_ec_c35_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(tti_ec_c55_kl(NGLLX,NGLLZ,nspec_elastic_b))

  allocate(tti_ecu_rho_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(tti_ecu_c11_kl(NGLLX,NGLLZ,nspec_elastic_b))
  ...
  allocate(tti_thom_beta_kl(NGLLX,NGLLZ,nspec_elastic_b))
  ...
  allocate(Qbeta_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(Qkappa_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(Qmu_kl(NGLLX,NGLLZ,nspec_elastic_b))
  ! HTI Thomsen parameterization PWY
  allocate(hti_thom_rhop_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom_alpha_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom_beta_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom_epsilon_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom_delta_kl(NGLLX,NGLLZ,nspec_elastic_b))

  allocate(hti_thom2_rhop_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom2_alpha_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom2_beta_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom2_epsilon_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom2_delta_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_thom2_eta_kl(NGLLX,NGLLZ,nspec_elastic_b))

  allocate(hti_vel_rhop_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_vel_alpha_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_vel_beta_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_vel_alphah_kl(NGLLX,NGLLZ,nspec_elastic_b))
  allocate(hti_vel_alphan_kl(NGLLX,NGLLZ,nspec_elastic_b))
