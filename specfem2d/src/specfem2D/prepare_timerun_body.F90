...
! if the memory is not cleaned
    ...
    if(assign_external_model) then
      ...
      allocate(c11uext(NGLLX,NGLLZ,nspec))
      allocate(c13uext(NGLLX,NGLLZ,nspec))
      allocate(c33uext(NGLLX,NGLLZ,nspec))
      allocate(c55uext(NGLLX,NGLLZ,nspec))
      allocate(thetaext(NGLLX,NGLLZ,nspec))
...
! displacement, velocity, acceleration and inverse of the mass matrix for elastic elements
  if (myrank == 0) then
    ...
    if(SIMULATION_TYPE == 3 .and. any_elastic) then
      ...
      allocate(lambdal_global(nglob))
      allocate(ipl_global(nglob))
      allocate(isl_global(nglob))
      allocate(sigmal_global(nglob))
      allocate(vpl_global(nglob))
      allocate(vsl_global(nglob))
      ...
      allocate(pdh_vp(NGLLX,NGLLZ,nspec))
      allocate(pdh_vs(NGLLX,NGLLZ,nspec))
      allocate(pdh_rhop(NGLLX,NGLLZ,nspec))
      allocate(pdh_kappa(NGLLX,NGLLZ,nspec))
      allocate(pdh_mu(NGLLX,NGLLZ,nspec))
      allocate(pdh_rho(NGLLX,NGLLZ,nspec))
      allocate(pdh_dl_lambda(NGLLX,NGLLZ,nspec))
      allocate(pdh_dl_mu(NGLLX,NGLLZ,nspec))
      allocate(pdh_dl_rho(NGLLX,NGLLZ,nspec))
      allocate(pdh_dip_ip(NGLLX,NGLLZ,nspec))
      allocate(pdh_dip_is(NGLLX,NGLLZ,nspec))
      allocate(pdh_dip_rho(NGLLX,NGLLZ,nspec))
      allocate(pdh_vipi_vp(NGLLX,NGLLZ,nspec))
      allocate(pdh_vipi_vs(NGLLX,NGLLZ,nspec))
      allocate(pdh_vipi_ip(NGLLX,NGLLZ,nspec))
      allocate(pdh_vipii_vp(NGLLX,NGLLZ,nspec))
      allocate(pdh_vipii_vs(NGLLX,NGLLZ,nspec))
      allocate(pdh_vipii_is(NGLLX,NGLLZ,nspec))
      allocate(pdh_sigma_vp(NGLLX,NGLLZ,nspec))
      allocate(pdh_sigma_sigma(NGLLX,NGLLZ,nspec))
      allocate(pdh_sigma_rho(NGLLX,NGLLZ,nspec))

      allocate(pdh_vp_temp(nglob))
      allocate(pdh_vs_temp(nglob))
      allocate(pdh_rhop_temp(nglob))
      allocate(pdh_kappa_temp(nglob))
      allocate(pdh_mu_temp(nglob))
      allocate(pdh_rho_temp(nglob))
      allocate(pdh_dl_lambda_temp(nglob))
      allocate(pdh_dl_mu_temp(nglob))
      allocate(pdh_dl_rho_temp(nglob))
      allocate(pdh_dip_ip_temp(nglob))
      allocate(pdh_dip_is_temp(nglob))
      allocate(pdh_dip_rho_temp(nglob))
      allocate(pdh_vipi_vp_temp(nglob))
      allocate(pdh_vipi_vs_temp(nglob))
      allocate(pdh_vipi_ip_temp(nglob))
      allocate(pdh_vipii_vp_temp(nglob))
      allocate(pdh_vipii_vs_temp(nglob))
      allocate(pdh_vipii_is_temp(nglob))
      allocate(pdh_sigma_vp_temp(nglob))
      allocate(pdh_sigma_sigma_temp(nglob))
      allocate(pdh_sigma_rho_temp(nglob))

      allocate(pdh_vp_temp1(nglob))
      allocate(pdh_vs_temp1(nglob))
      allocate(pdh_rhop_temp1(nglob))
      allocate(pdh_kappa_temp1(nglob))
      allocate(pdh_mu_temp1(nglob))
      allocate(pdh_rho_temp1(nglob))
      allocate(pdh_dl_lambda_temp1(nglob))
      allocate(pdh_dl_mu_temp1(nglob))
      allocate(pdh_dl_rho_temp1(nglob))
      allocate(pdh_dip_ip_temp1(nglob))
      allocate(pdh_dip_is_temp1(nglob))
      allocate(pdh_dip_rho_temp1(nglob))
      allocate(pdh_vipi_vp_temp1(nglob))
      allocate(pdh_vipi_vs_temp1(nglob))
      allocate(pdh_vipi_ip_temp1(nglob))
      allocate(pdh_vipii_vp_temp1(nglob))
      allocate(pdh_vipii_vs_temp1(nglob))
      allocate(pdh_vipii_is_temp1(nglob))
      allocate(pdh_sigma_vp_temp1(nglob))
      allocate(pdh_sigma_sigma_temp1(nglob))
      allocate(pdh_sigma_rho_temp1(nglob))

      allocate(pdh_hti_ec_c11(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_ec_c13(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_ec_c33(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_ec_c55(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_ec_rho(NGLLX,NGLLZ,nspec))

      allocate(pdh_hti_ec_c11_temp(nglob))
      allocate(pdh_hti_ec_c13_temp(nglob))
      allocate(pdh_hti_ec_c33_temp(nglob))
      allocate(pdh_hti_ec_c55_temp(nglob))
      allocate(pdh_hti_ec_rho_temp(nglob))

      allocate(pdh_hti_ec_c11_temp1(nglob))
      allocate(pdh_hti_ec_c13_temp1(nglob))
      allocate(pdh_hti_ec_c33_temp1(nglob))
      allocate(pdh_hti_ec_c55_temp1(nglob))
      allocate(pdh_hti_ec_rho_temp1(nglob))

      allocate(pdh_tti_ec_c11(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ec_c13(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ec_c15(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ec_c33(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ec_c35(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ec_c55(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ec_rho(NGLLX,NGLLZ,nspec))

      allocate(pdh_tti_ecu_c11(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ecu_c13(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ecu_c33(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ecu_c55(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ecu_rho(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_ecu_theta(NGLLX,NGLLZ,nspec))

      allocate(pdh_tti_thom_alpha(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_thom_beta(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_thom_epsilon(NGLLX,NGLLZ,nspec))
      allocate(pdh_tti_thom_delta(NGLLX,NGLLZ,nspec))
      ...
      allocate(pdh_tti_ec_c33_temp(nglob))
      allocate(pdh_tti_ec_c35_temp(nglob))
      allocate(pdh_tti_ec_c55_temp(nglob))
      allocate(pdh_tti_ec_rho_temp(nglob))

      allocate(pdh_tti_ecu_c11_temp(nglob))
      allocate(pdh_tti_ecu_c13_temp(nglob))
      allocate(pdh_tti_ecu_c33_temp(nglob))
      allocate(pdh_tti_ecu_c55_temp(nglob))
      allocate(pdh_tti_ecu_rho_temp(nglob))
      allocate(pdh_tti_ecu_theta_temp(nglob))

      allocate(pdh_tti_thom_alpha_temp(nglob))
      allocate(pdh_tti_thom_beta_temp(nglob))
      allocate(pdh_tti_thom_epsilon_temp(nglob))
      ...
      allocate(pdh_tti_ec_c15_temp1(nglob))
      allocate(pdh_tti_ec_c33_temp1(nglob))
      allocate(pdh_tti_ec_c35_temp1(nglob))
      allocate(pdh_tti_ec_c55_temp1(nglob))
      allocate(pdh_tti_ec_rho_temp1(nglob))

      allocate(pdh_hti_thom_alpha(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom_beta(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom_epsilon(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom_delta(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom_rhop(NGLLX,NGLLZ,nspec))

      allocate(pdh_hti_thom_alpha_temp(nglob))
      allocate(pdh_hti_thom_beta_temp(nglob))
      allocate(pdh_hti_thom_epsilon_temp(nglob))
      allocate(pdh_hti_thom_delta_temp(nglob))
      allocate(pdh_hti_thom_rhop_temp(nglob))

      allocate(pdh_hti_thom2_alpha(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom2_beta(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom2_epsilon(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom2_delta(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom2_rhop(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_thom2_eta(NGLLX,NGLLZ,nspec))

      allocate(pdh_hti_thom2_alpha_temp(nglob))
      allocate(pdh_hti_thom2_beta_temp(nglob))
      allocate(pdh_hti_thom2_epsilon_temp(nglob))
      allocate(pdh_hti_thom2_delta_temp(nglob))
      allocate(pdh_hti_thom2_rhop_temp(nglob))
      allocate(pdh_hti_thom2_eta_temp(nglob))

      allocate(pdh_hti_vel_alpha(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_vel_beta(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_vel_alphah(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_vel_alphan(NGLLX,NGLLZ,nspec))
      allocate(pdh_hti_vel_rhop(NGLLX,NGLLZ,nspec))

      allocate(pdh_hti_vel_alpha_temp(nglob))
      allocate(pdh_hti_vel_beta_temp(nglob))
      allocate(pdh_hti_vel_alphah_temp(nglob))
      allocate(pdh_hti_vel_alphan_temp(nglob))
      allocate(pdh_hti_vel_rhop_temp(nglob))

      allocate(hti_rhol_global(nglob)) ! PWY
      allocate(hti_c11l_global(nglob)) ! PWY
      allocate(hti_c13l_global(nglob)) ! PWY
      allocate(hti_c33l_global(nglob)) ! PWY
      allocate(hti_c55l_global(nglob)) ! PWY
      allocate(hti_ec_rho_k(nglob)) !PWY
      allocate(hti_ec_c11_k(nglob)) !PWY
      allocate(hti_ec_c13_k(nglob)) !PWY
      allocate(hti_ec_c33_k(nglob)) !PWY
      allocate(hti_ec_c55_k(nglob)) !PWY
      allocate(hti_ec_rho_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_ec_c11_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_ec_c13_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_ec_c33_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_ec_c55_kl(NGLLX,NGLLZ,nspec)) !PWY

      allocate(dl_lambda_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(dl_mu_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(dl_rho_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(dip_ip_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(dip_is_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(dip_rho_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(vipi_vp_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(vipi_vs_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(vipi_ip_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(vipii_vp_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(vipii_vs_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(vipii_is_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(sigma_vp_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(sigma_sigma_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(sigma_rho_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(dl_lambda_k(nglob)) !PWY
      allocate(dl_mu_k(nglob)) !PWY
      allocate(dl_rho_k(nglob)) !PWY
      allocate(dip_ip_k(nglob)) !PWY
      allocate(dip_is_k(nglob)) !PWY
      allocate(dip_rho_k(nglob)) !PWY
      allocate(vipi_vp_k(nglob)) !PWY
      allocate(vipi_vs_k(nglob)) !PWY
      allocate(vipi_ip_k(nglob)) !PWY
      allocate(vipii_vp_k(nglob)) !PWY
      allocate(vipii_vs_k(nglob)) !PWY
      allocate(vipii_is_k(nglob)) !PWY
      allocate(sigma_vp_k(nglob)) !PWY
      allocate(sigma_sigma_k(nglob)) !PWY
      allocate(sigma_rho_k(nglob)) !PWY

      allocate(tti_rhol_global(nglob)) ! PWY
      allocate(tti_c11l_global(nglob)) ! PWY
      allocate(tti_c13l_global(nglob)) ! PWY
      allocate(tti_c15l_global(nglob)) ! PWY
      allocate(tti_c33l_global(nglob)) ! PWY
      allocate(tti_c35l_global(nglob)) ! PWY
      allocate(tti_c55l_global(nglob)) ! PWY
      allocate(tti_ec_rho_k(nglob)) !PWY
      allocate(tti_ec_c11_k(nglob)) !PWY
      allocate(tti_ec_c13_k(nglob)) !PWY
      allocate(tti_ec_c15_k(nglob)) !PWY
      allocate(tti_ec_c33_k(nglob)) !PWY
      allocate(tti_ec_c35_k(nglob)) !PWY
      allocate(tti_ec_c55_k(nglob)) !PWY 
      allocate(tti_ec_rho_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ec_c11_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ec_c13_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ec_c15_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ec_c33_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ec_c35_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ec_c55_kl(NGLLX,NGLLZ,nspec)) !PWY

      allocate(tti_rhoul_global(nglob)) ! PWY
      allocate(tti_c11ul_global(nglob)) ! PWY
      allocate(tti_c13ul_global(nglob)) ! PWY
      allocate(tti_c33ul_global(nglob)) ! PWY
      allocate(tti_c55ul_global(nglob)) ! PWY
      allocate(tti_thetaul_global(nglob)) ! PWY

      allocate(tti_ecu_rho_k(nglob)) !PWY
      allocate(tti_ecu_c11_k(nglob)) !PWY
      allocate(tti_ecu_c13_k(nglob)) !PWY
      allocate(tti_ecu_c33_k(nglob)) !PWY
      allocate(tti_ecu_c55_k(nglob)) !PWY
      allocate(tti_ecu_theta_k(nglob)) !PWY
      allocate(tti_ecu_rho_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ecu_c11_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ecu_c13_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ecu_c33_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_ecu_c55_kl(NGLLX,NGLLZ,nspec)) !PWY 
      allocate(tti_ecu_theta_kl(NGLLX,NGLLZ,nspec)) !PWY 

      allocate(tti_thom_rhop_k(nglob)) !PWY
      allocate(tti_thom_alpha_k(nglob)) !PWY
      allocate(tti_thom_beta_k(nglob)) !PWY
      allocate(tti_thom_epsilon_k(nglob)) !PWY
      allocate(tti_thom_delta_k(nglob)) !PWY
      allocate(tti_thom_theta_k(nglob)) !PWY
      allocate(tti_thom_rhop_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_thom_alpha_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(tti_thom_beta_kl(NGLLX,NGLLZ,nspec)) !PWY
      ...
      allocate(tti_betal_global(nglob)) ! PWY
      allocate(tti_epsilonl_global(nglob)) ! PWY
      allocate(tti_deltal_global(nglob)) ! PWY
      allocate(tti_coeffl_global(nglob)) ! PWY

      allocate(m1l_global(nglob)) !PWY
      allocate(m2l_global(nglob)) !PWY
      allocate(m3l_global(nglob)) !PWY
      allocate(m4l_global(nglob)) !PWY
      allocate(m5l_global(nglob)) !PWY
      allocate(m6l_global(nglob)) !PWY
      allocate(p1l_global(nglob)) !PWY
      allocate(p2l_global(nglob)) !PWY

      ! HTI Thomsen Parameterization PWY
      allocate(hti_rhopl_global(nglob)) ! PWY
      allocate(hti_alphal_global(nglob)) ! PWY
      allocate(hti_alphahl_global(nglob)) ! PWY
      allocate(hti_alphanl_global(nglob)) ! PWY
      allocate(hti_betal_global(nglob)) ! PWY
      allocate(hti_epsilonl_global(nglob)) ! PWY
      allocate(hti_deltal_global(nglob)) ! PWY
      allocate(hti_etal_global(nglob))
      allocate(hti_coeffl_global(nglob)) ! PWY
      allocate(hti_thom_rhop_k(nglob)) !PWY
      allocate(hti_thom_alpha_k(nglob)) !PWY
      allocate(hti_thom_beta_k(nglob)) !PWY
      allocate(hti_thom_epsilon_k(nglob)) !PWY
      allocate(hti_thom_delta_k(nglob)) !PWY
      allocate(hti_thom_rhop_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom_alpha_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom_beta_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom_epsilon_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom_delta_kl(NGLLX,NGLLZ,nspec)) !PWY

      allocate(hti_thom2_rhop_k(nglob)) !PWY
      allocate(hti_thom2_alpha_k(nglob)) !PWY
      allocate(hti_thom2_beta_k(nglob)) !PWY
      allocate(hti_thom2_epsilon_k(nglob)) !PWY
      allocate(hti_thom2_delta_k(nglob)) !PWY
      allocate(hti_thom2_eta_k(nglob)) !PWY
      allocate(hti_thom2_rhop_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom2_alpha_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom2_beta_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom2_epsilon_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom2_delta_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_thom2_eta_kl(NGLLX,NGLLZ,nspec)) !PWY

      allocate(hti_vel_rhop_k(nglob)) !PWY
      allocate(hti_vel_alpha_k(nglob)) !PWY
      allocate(hti_vel_beta_k(nglob)) !PWY
      allocate(hti_vel_alphah_k(nglob)) !PWY
      allocate(hti_vel_alphan_k(nglob)) !PWY
      allocate(hti_vel_rhop_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_vel_alpha_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_vel_beta_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_vel_alphah_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(hti_vel_alphan_kl(NGLLX,NGLLZ,nspec)) !PWY

      !! Attenuation Kernels
      allocate(Qalphal_global(nglob)) ! PWY
      allocate(Qbetal_global(nglob)) ! PWY
      allocate(Qkappal_global(nglob))
      allocate(Qmul_global(nglob))
      allocate(Qalpha_k(nglob)) !PWY
      allocate(Qbeta_k(nglob)) !PWY
      allocate(Qkappa_k(nglob)) !PWY
      allocate(Qmu_k(nglob)) !PWY
      allocate(Qalpha_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(Qbeta_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(Qkappa_kl(NGLLX,NGLLZ,nspec)) !PWY
      allocate(Qmu_kl(NGLLX,NGLLZ,nspec)) !PWY
    else
...
do ispec=1,nspec
          do j = 1,NGLLZ
              ...
              c33store(i,j,ispec) = c33ext(i,j,ispec)  !PWY
              c35store(i,j,ispec) = c35ext(i,j,ispec)  !PWY
              c55store(i,j,ispec) = c55ext(i,j,ispec)  !PWY
              c12store(i,j,ispec) = c12ext(i,j,ispec)  !PWY
              c23store(i,j,ispec) = c23ext(i,j,ispec)  !PWY
              c25store(i,j,ispec) = c25ext(i,j,ispec)  !PWY
              enddo
          enddo
enddo
